...
class CompilerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_generate_runtime_model.side_effect = (
    ...
    def test__prepend_ctes__no_ctes(self):
        ...
        self.assertEqualIgnoreWhitespace(
            result.compiled_sql, manifest.nodes.get("model.root.view").compiled_sql
        )

        compiler = dbt.compilation.Compiler(self.config)
        result, _ = compiler._recursively_prepend_ctes(
            manifest.nodes.get("model.root.view_no_cte"), manifest, {}
        )
