...
class TestDocsGenerate(DBTIntegrationTest):
    ...
    def expected_bigquery_complex_catalog(self):
        ...
        clustering_stats = self._bigquery_stats(
            True, partition="updated_at", cluster="first_name"
        )
        multi_clustering_stats = self._bigquery_stats(
            True, partition="updated_at", cluster="first_name, email"
        )
        nesting_columns = {
            "field_1": {
                "name": "field_1",
        ...
        return {
            ...
            "nodes": {
                ...
                "test.test.not_null_model_id": {
                    ...
                    "build_path": Normalized(
                        "target/compiled/test/models/schema.yml/schema_test/not_null_model_id.sql"
                    ),
                    "column_name": "id",
                    "columns": {},
                    "config": test_config,
                ...
                "test.test.test_nothing_model_": {
                    ...
                    "build_path": Normalized(
                        "target/compiled/test/models/schema.yml/schema_test/test_nothing_model_.sql"
                    ),
                    "column_name": None,
                    "columns": {},
                    "config": test_config,
                ...
                "test.test.unique_model_id": {
                    ...
                    "build_path": Normalized(
                        "target/compiled/test/models/schema.yml/schema_test/unique_model_id.sql"
                    ),
                    "column_name": "id",
                    "columns": {},
                    "config": test_config,
        ...
        return {
            ...
            "nodes": {
                "model.test.clustered": {
                    ...
                    "fqn": ["test", "clustered"],
                    "build_path": Normalized(
                        "target/compiled/test/bq_models/clustered.sql"
                    ),
                    "name": "clustered",
                    ...
                    "path": "clustered.sql",
                    "raw_sql": LineIndifferent(
                        _read_file(clustered_sql_path).rstrip("\r\n")
                    ),
                    "refs": [["seed"]],
                ...
                "model.test.multi_clustered": {
                    ...
                    "build_path": Normalized(
                        "target/compiled/test/bq_models/multi_clustered.sql"
                    ),
                    "config": self.rendered_model_config(
                    ...
                    "raw_sql": LineIndifferent(
                        _read_file(multi_clustered_sql_path).rstrip("\r\n")
                    ),
                    "refs": [["seed"]],
                ...
                "model.test.nested_view": {
                    "alias": "nested_view",
                    "build_path": Normalized(
                        "target/compiled/test/bq_models/nested_view.sql"
                    ),
                    "config": self.rendered_model_config(),
                    "sources": [],
                    "depends_on": {"macros": [], "nodes": ["model.test.nested_table"]},
                    ...
                    "raw_sql": LineIndifferent(
                        _read_file(nested_view_sql_path).rstrip("\r\n")
                    ),
                    "refs": [["nested_table"]],
                ...
                "model.test.nested_table": {
                    "alias": "nested_table",
                    "build_path": Normalized(
                        "target/compiled/test/bq_models/nested_table.sql"
                    ),
                    "config": self.rendered_model_config(materialized="table"),
                    "sources": [],
                    "depends_on": {"macros": [], "nodes": []},
                    ...
                    "raw_sql": LineIndifferent(
                        _read_file(nested_table_sql_path).rstrip("\r\n")
                    ),
                    "refs": [],
    ...
    def expected_redshift_incremental_view_manifest(self):
        ...
        return {
            ...
            "nodes": {
                "model.test.model": {
                    "build_path": Normalized(
                        "target/compiled/test/rs_models/model.sql"
                    ),
                    "name": "model",
                    "root_path": self.test_root_realpath,
            ...
            "child_map": {
                "model.test.model": [],
                "seed.test.seed": ["model.test.model", "snapshot.test.snapshot_seed"],
                "snapshot.test.snapshot_seed": [],
            },
            "docs": {
                "dbt.__overview__": ANY,
    ...
    def test__snowflake__run_and_generate_ignore_quoting_parameter(self):
        ...
        def connect(*args, **kwargs):
            kwargs["session_parameters"] = {"QUOTED_IDENTIFIERS_IGNORE_CASE": True}
    ...
    def test__bigquery__complex_models(self):
        self.run_and_generate(
            extra={"source-paths": [self.dir("bq_models")]}, model_count=4
        )
    ...
    def test_bigquery_docs_generate_noschema(self):
        self.run_dbt(
            [
                ...
                "generate",
                "--vars",
                "{{extra_schema: {}}}".format(self.extra_schema),
            ]
        )
